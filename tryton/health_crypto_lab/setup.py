...
setup(
    ...
    package_dir={'trytond.modules.health_crypto_lab': '.'},
    packages=[
        'trytond.modules.health_crypto_lab',
        'trytond.modules.health_crypto_lab.tests',
        ],

    package_data={
        'trytond.modules.health_crypto_lab': info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    health_crypto_lab = trytond.modules.health_crypto_lab
    """,
    test_suite='tests',
