...
Person and family socioeconomic history and assessment for GNU Health HIS
#########################################################################

The package *health-socioeconomics* includes the socio-economic determinants of health 
