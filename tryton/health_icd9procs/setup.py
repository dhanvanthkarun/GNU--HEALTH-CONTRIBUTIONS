...
setup(
    ...
    description=info.get(
        'description',
        'GNU Health WHO ICD9 - Volume 3 - procedures package'),
    long_description=read('README.rst'),
    author='GNU Solidario',
    author_email='health@gnusolidario.org',
    url='https://www.gnuhealth.org',
    download_url='http://ftp.gnu.org/gnu/health/',
    package_dir={'trytond.modules.health_icd9procs': '.'},
    packages=[
        'trytond.modules.health_icd9procs',
        'trytond.modules.health_icd9procs.tests',
        ],

    package_data={
        'trytond.modules.health_icd9procs': info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    health_icd9procs = trytond.modules.health_icd9procs
    """,
    test_suite='tests',
