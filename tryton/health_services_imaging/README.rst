...
Medical Imaging Services and billing package for GNU Health HIS
###############################################################

The package *health-service-imaging* has the functionality for Medical 
Imaging orders to the *health-service* package
