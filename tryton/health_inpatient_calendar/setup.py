...
setup(name='gnuhealth_inpatient_calendar',
      ...
      description=info.get(
          'description',
          'GNU Health package for hospitalization calendar functionality'),
      long_description=read('README.rst'),
      author='GNU Solidario',
      author_email='health@gnusolidario.org',
      url='https://www.gnuhealth.org',
      download_url='http://ftp.gnu.org/gnu/health/',
      package_dir={'trytond.modules.health_inpatient_calendar': '.'},
      packages=[
      ...
      entry_points="""
    [trytond.modules]
    health_inpatient_calendar = trytond.modules.health_inpatient_calendar
    """,
      test_suite='tests',
