...
setup(
    ...
    description=info.get(
        'description',
        'GNU Health package for stock management'),
    long_description=read('README.rst'),
    author='GNU Solidario',
    author_email='health@gnusolidario.org',
    url='https://www.gnuhealth.org',
    download_url='http://ftp.gnu.org/gnu/health/',
    package_dir={'trytond.modules.health_stock': '.'},
    packages=[
        'trytond.modules.health_stock',
        'trytond.modules.health_stock.tests',
        'trytond.modules.health_stock.wizard',
    ],
    ...
    entry_points="""
    [trytond.modules]
    health_stock = trytond.modules.health_stock
    """,
    test_suite='tests',
