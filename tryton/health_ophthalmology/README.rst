...
Ophthalmology package for GNU Health HIS
########################################

The package *health-ophthalmology* provides ophthalmology and optometry functionality
for the GNU Health Hospital Information System.
