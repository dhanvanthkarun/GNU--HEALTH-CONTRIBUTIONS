...
class OrthancWorklistTemplate(ModelSQL, ModelView):
    ...
    template_type = fields.Selection([
        ('dump2dcm', 'dump2dcm'),
        ('python-orthanc-tools', 'python-orthanc-tools'),
    ], 'Template Type')
    ...
    template = fields.Text(
        ...
        "if template type is python-orthanc-tools, worklist wl file "
        "can be generated by python-orthanc-tools.")
    ...
    dump_file_encoding = fields.Char(
        ...
        'This field is useful when template type is dump2dcm.')
