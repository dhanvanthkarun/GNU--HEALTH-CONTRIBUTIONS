...
GNU Health Medical Imaging DICOM worklist package for GNU Health HIS
####################################################################

The *health-imaging-worklist* package provides the basic functionality
for DICOM patient worklists, on top of the *health_imaging* core package.
