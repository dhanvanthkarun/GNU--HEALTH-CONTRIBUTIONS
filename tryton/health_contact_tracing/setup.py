...
setup(
    ...
    package_dir={'trytond.modules.health_contact_tracing': '.'},
    packages=[
        'trytond.modules.health_contact_tracing',
        'trytond.modules.health_contact_tracing.tests',
        ],
    ...
    entry_points="""
    [trytond.modules]
    health_contact_tracing = trytond.modules.health_contact_tracing
    """,
    test_suite='tests',
