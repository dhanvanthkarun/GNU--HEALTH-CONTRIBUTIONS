...
Cryptography package for GNU Health HIS
#######################################

The *health-crypto* package provides basic methods and models to enhance 
confidenciality, integrity and non-repudiation in GNU Health Hospital Management System
