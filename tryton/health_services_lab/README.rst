...
Laboratory Services and billing package for GNU Health HIS
##########################################################

The package *health-service-lab* adds the functionality for lab orders 
to the *health-service* package
