...
ICD10-PCS (Procedure Coding System) package for GNU Health HIS
##############################################################

The package *health_icd10pcs* provides ICD10-PCS procedure coding
system used mainly in the United States.
