...
WebDAV server for GNU Health HIS
================================

The *gnuhealth-webdav3-server* package provides a WebDAV server that is used by GNU Health packages,
such *gnuhealth-caldav* or *gnuhealth-calendar*.

The server is started by running `gnuhealth-webdav-server`.

The WebDAV server is the continuation of the orginal server for Tryton, ported to Python 3 and to be compatible with GNU Health HIS.
