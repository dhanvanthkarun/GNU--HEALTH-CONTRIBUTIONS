...
setup(
    ...
    description=info.get(
        'description',
        'GNU Health package to manage insurances and associated services'),
    long_description=read('README.rst'),
    author='GNU Solidario',
    author_email='health@gnusolidario.org',
    url='https://www.gnuhealth.org',
    download_url='http://ftp.gnu.org/gnu/health/',
    package_dir={'trytond.modules.health_insurance': '.'},
    packages=[
    ...
    package_data={
        'trytond.modules.health_insurance': info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    health_insurance = trytond.modules.health_insurance
    """,
    test_suite='tests',
