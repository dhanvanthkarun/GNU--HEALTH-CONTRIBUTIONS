...
def parse_options():
    ...
    parser.add_argument('-D', '--directory',
                        help="A directory which contain "
                        "csv or ods data files.")
...
def import_line_patient(line):
    ...
    # Use this if one address only, so it won't leave the first record
    # blank
...
def import_line_medicament(line):
    ...
    print("* Importing product: '{0} ({1})'".format(
