...
Dentistry package for GNU Health HIS
-------------------------------------

The health-dentistry package is focused on dental health and it provides 
dentistry procedures, treatments, reports and generation of odontograms.
