...
setup(
    ...
    description=info.get(
        'description',
        'GNU Health Genetics UniProt Human Natural Variants Database'),
    ...
    package_dir={'trytond.modules.health_genetics_uniprot': '.'},
    packages=[
    ...
    entry_points="""
    [trytond.modules]
    health_genetics = trytond.modules.health_genetics_uniprot
    """,
    test_suite='tests',
