...
ICD10 package for GNU Health HIS
################################

The package *health_icd10* provides the World Health Organization
International Classification of Diseases, 10th revision for GNU HEALTH.
