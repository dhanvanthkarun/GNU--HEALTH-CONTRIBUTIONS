...
#########################################################################
#                HEALTH WHO_ESSENTIAL_MEDICINES package                 #
...
setup(
    ...
    description=info.get(
        'description',
        'GNU Health WHO Essential Medicines package'),
    long_description=read('README.rst'),
    author='GNU Solidario',
    author_email='health@gnusolidario.org',
    url='https://www.gnuhealth.org',
    download_url='http://ftp.gnu.org/gnu/health/',
    package_dir={'trytond.modules.health_who_essential_medicines': '.'},
    packages=[
    ...
    package_data={
        'trytond.modules.health_who_essential_medicines': info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    health_who_essential_medicines = trytond.modules.health_who_essential_medicines
    """,
    test_suite='tests',
