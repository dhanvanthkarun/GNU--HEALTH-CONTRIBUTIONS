...
#                 health_lifestyle.py: main module                      #
#########################################################################
...
class PatientCAGE(ModelSQL, ModelView):
    ...
    cage_c = fields.Boolean(
        'Hard to Cut down', help='Have you ever felt you '
        'needed to Cut down on your drinking?')
    cage_a = fields.Boolean(
        'Angry with Critics', help='Have people Annoyed '
        'you by criticizing your drinking?')
    cage_g = fields.Boolean(
        'Guilt', help='Have you ever felt Guilty about '
        'drinking?')
    cage_e = fields.Boolean(
        'Eye-opener', help='Have you ever felt you '
...
class MedicalPatient(ModelSQL, ModelView):
    ...
    vegetarian_type = fields.Many2One(
        'gnuhealth.vegetarian_types', 'Vegetarian')
