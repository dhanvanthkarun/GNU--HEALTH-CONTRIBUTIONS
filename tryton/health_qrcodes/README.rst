...
QR and Barcode functionality for GNU Health HIS
###############################################

The *health_qrcodes* provides the main classes and methods to generate
bar and quick response (QR) codes for patients, laboratory and other contexts.
